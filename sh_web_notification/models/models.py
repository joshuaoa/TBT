                ...
                if self.notification_type == 'warning':
                    ...
                    for user in self.user_ids:
                        notifications.append([
                            ...
                            {'type': 'user_connection', 'title': _('Notitification'), 'message': CODE_SOUND_SUCCESS + self.description_text, 'sticky': True, 'warning': True}  # sorted to make deterministic for tests
                        ])
